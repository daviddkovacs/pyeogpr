...
.. code-block:: python
    ...
    dc = pyeogpr.Datacube("SENTINEL2_L1C", # Satellite sensor
                          bounding_box,
                          time_window,
                          cloudmask =True)
    
    dc.construct_datacube() #Initiates openEO datacube
    
    dc.process_map("FVC")   #Starts GPR processing of the selected biophysical variable
